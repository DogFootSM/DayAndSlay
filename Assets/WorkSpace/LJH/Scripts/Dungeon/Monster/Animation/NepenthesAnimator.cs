...
public class NepenthesAnimator : MonsterAnimator
{
    protected override void DictionaryInit()
    {
        ...
        skillFourthAction.Add(Direction.Left, "MonsterSkillFourthDown");
        skillFourthAction.Add(Direction.Right, "MonsterSkillFourthDown");
        skillFourthAction.Add(Direction.Up, "MonsterSkillFourthDown");
