...
{
   INVENTORY_OPEN, INVENTORY_FLIP, INVENTORY_CLOSE, INVENTORY_TAB_HOVER, ITEM_EQUIP, ITEM_UNEQUIP, ARROW_BUTTON_SELECT, UI_BUTTON_CLICK, GAMESTART, SLOTDROP, NORMAL_ATTACK
}
